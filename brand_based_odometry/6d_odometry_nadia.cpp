...
//void brand_matching(cv::Mat& rgb1, cv::Mat& cloud1,  pcl::PointCloud<pcl::PointXYZ>::Ptr& pcl_cloud1, cv::Mat& rgb2, cv::Mat& cloud2,  pcl::PointCloud<pcl::PointXYZ>::Ptr pcl_cloud2, std::vector<cv::KeyPoint>& keypoints1, std::vector<cv::KeyPoint>& keypoints2, std::vector<cv::DMatch>& matches, pcl::PointCloud<pcl::Normal>::Ptr& normals1pcl,pcl::PointCloud<pcl::Normal>::Ptr& normals2pcl){

//void brand_matching(cv::Mat& rgb1, cv::Mat& cloud1, cv::Mat& rgb2, cv::Mat& cloud2, std::vector<cv::KeyPoint>& keypoints1, std::vector<cv::KeyPoint>& keypoints2, std::vector<cv::DMatch>& matches, cv::Mat& normals1, cv::Mat& normals2){
